...
const advisoryBoard: TeamMember[] = [
  ...
  },
  {
    ...
    role: "Advisory Board Member",
    roleFr: "Membre du conseil consultatif",
    organization: "Chief Corporate Development, Sustainability and Risk Officer, Equinox Gold Corp.",
    organizationFr: "Directrice du développement d'entreprise, de la durabilité et des risques, Equinox Gold Corp.",
