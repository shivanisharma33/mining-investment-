...
export default function PastEdition2024Page() {
  const { lang } = useLanguage();
  const isFr = lang === "FR";
  const viewingEdition = 2024;
                ...
                {activeTab === "companies" ? (
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-6 md:gap-10 pb-8 mb-8 border-b border-neutral-200 text-xs sm:text-sm font-medium text-neutral-700">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <b className="block text-neutral-900 font-extrabold text-sm sm:text-base">
                            {isFr ? `4 – 6 juin ${viewingEdition}` : `June 4 – 6, ${viewingEdition}`}
                          </b>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <b className="block text-neutral-900 font-extrabold text-sm sm:text-base">PDF, 14.2 MB</b>
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600 text-sm sm:text-base font-medium leading-relaxed max-w-[700px] mb-6">
                      {isFr
                        ? "Le principal événement mondial d'investissement minier axé sur l'avenir des minéraux critiques et la croissance durable."
                        : "The premier global mining investment event focusing on the future of critical minerals and sustainable growth."}
                    </p>
                    ...
                    <div className="flex flex-wrap items-center gap-6 sm:gap-10 text-xs sm:text-sm font-extrabold text-neutral-800 uppercase mb-8">
                      <div className="flex items-center gap-2">
                        ...
                        <span>{isFr ? `4 – 6 JUIN ${viewingEdition}` : `JUNE 4 – 6, ${viewingEdition}`}</span>
                      </div>
                    ...
                    <div className="mb-12">
                      ...
                      <p className="text-neutral-600 text-xs sm:text-sm leading-relaxed mb-6 font-medium max-w-[760px]">
                        {isFr
                          ? "Mining Investment Event 2024 s'est concentré sur les opportunités d'investissement dans les minéraux critiques et la transition énergétique durable."
                          : "Mining Investment Event 2024 focused on investment opportunities in critical minerals and the sustainable energy transition."}
                      </p>
                    </div>
                  </div>
                )}
