...
/**
 * Server-side proxy for student registration submissions. The backend accepts
...
export async function POST(request: NextRequest) {
  try {
    ...
    const res = await fetch(
      "https://mining-investment-backend.vercel.app/api/student-registrations",
      {
        method: "POST",
        headers: {
    ...
    console.error("Proxy Student Registration Error:", error);
