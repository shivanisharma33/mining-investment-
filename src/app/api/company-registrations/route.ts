...
/**
 * Server-side proxy for company registration submissions. The backend accepts
...
export async function POST(request: NextRequest) {
  try {
    ...
    const res = await fetch(
      "https://typical-butterfly-3f86e59200.strapiapp.com/api/Company-Registrations",
      {
        method: "POST",
        headers: {
    ...
    console.error("Proxy Company Registration Error:", error);
