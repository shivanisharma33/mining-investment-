      ...
      <div className="relative z-10 max-w-[1240px] mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10 pb-12 border-b border-neutral-300/70 dark:border-zinc-800">
            ...
            <div className="mt-6 flex flex-col items-start gap-3">
              ...
              <div className="flex items-center gap-2.5 sm:gap-3 flex-wrap pt-1">
                {[
                  {
                    name: "LinkedIn",
                    href: "https://www.linkedin.com/company/the-mining-investment-event",
                    hoverBg: "hover:bg-[#0A66C2] hover:border-[#0A66C2] hover:shadow-[0_10px_25px_-3px_rgba(10,102,194,0.5)]",
                  ...
                  },
                  {
                    ...
                    hoverBg: "hover:bg-neutral-900 dark:hover:bg-white hover:border-neutral-900 dark:hover:border-white hover:shadow-[0_10px_25px_-3px_rgba(0,0,0,0.4)] dark:hover:shadow-[0_10px_25px_-3px_rgba(255,255,255,0.3)]",
                    iconHoverColor: "group-hover:text-white dark:group-hover:text-neutral-950",
                    svg: (
                  ...
                  {
                    name: "Facebook",
                    href: "https://www.facebook.com/people/The-Mining-Investment-Event/61578122472543/?mibextid=wwXIfr&rdid=FT1wovqTSU74EWdS&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1ADgS6wntq%2F%3Fmibextid%3DwwXIfr",
                    hoverBg: "hover:bg-[#1877F2] hover:border-[#1877F2] hover:shadow-[0_10px_25px_-3px_rgba(24,119,242,0.5)]",
                    iconHoverColor: "group-hover:text-white",
                    svg: (
                      <svg className="w-4.5 h-4.5 fill-current" viewBox="0 0 24 24">
                  ...
                  {
                    name: "Instagram",
                    href: "https://www.instagram.com/themininginvestmentevent?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw%3D%3D",
                    hoverBg: "hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] hover:border-transparent hover:shadow-[0_10px_25px_-3px_rgba(220,39,67,0.5)]",
                    iconHoverColor: "group-hover:text-white",
                    svg: (
                      <svg className="w-4.5 h-4.5 fill-current" viewBox="0 0 24 24">
                  ...
                  },
                  {
                    ...
                    hoverBg: "hover:bg-[#FF0000] hover:border-[#FF0000] hover:shadow-[0_10px_25px_-3px_rgba(255,0,0,0.5)]",
                    iconHoverColor: "group-hover:text-white",
                    svg: (
                      <svg className="w-4.5 h-4.5 fill-current" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    className={`group relative w-10.5 h-10.5 sm:w-11 sm:h-11 rounded-2xl bg-white dark:bg-[#202025] border border-neutral-200/90 dark:border-zinc-700/80 flex items-center justify-center text-neutral-600 dark:text-zinc-300 shadow-2xs ${social.hoverBg} transition-all duration-300 transform hover:-translate-y-1.5 hover:scale-105 active:scale-95 cursor-pointer`}
                  >
                    {/* Animated Icon */}
                    <span className={`transition-all duration-300 group-hover:scale-110 ${social.iconHoverColor}`}>
                      {social.svg}
                    </span>
                  </a>
                ))}
          ...
          <div className="lg:col-span-2 flex flex-col items-start text-left">
            ...
            <ul className="space-y-3 text-xs sm:text-sm font-bold">
              <li>
          ...
          <div className="lg:col-span-2 flex flex-col items-start text-left">
            ...
            <ul className="space-y-3 text-xs sm:text-sm font-bold">
              <li>
                <Link href="/about" className="text-neutral-700 dark:text-white hover:text-[#C6112F] dark:hover:text-[#C6112F] transition-colors">
              ...
              <li>
                <Link href="/travel" className="text-neutral-700 dark:text-white hover:text-[#C6112F] dark:hover:text-[#C6112F] transition-colors">
                  {t("nav-travel", "Travel & Accommodations")}
                </Link>
              </li>
              <li>
                <Link href="/partnership" className="text-neutral-700 dark:text-white hover:text-[#C6112F] dark:hover:text-[#C6112F] transition-colors">
          ...
          <div className="lg:col-span-3 flex flex-col items-start text-left">
            ...
            <ul className="space-y-3 text-xs sm:text-sm font-bold">
              ...
              <li>
                <Link href="/media" className="text-neutral-700 dark:text-white hover:text-[#C6112F] dark:hover:text-[#C6112F] transition-colors">
        ...
        <div className="pt-8 text-left">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-3">
            ...
            <Link
              href="/privacy-policy"
              className="text-[#C6112F] dark:text-white hover:text-[#a80d26] dark:hover:text-[#C6112F] font-extrabold text-xs sm:text-sm tracking-wider uppercase transition-colors inline-flex items-center gap-1.5"
            >
