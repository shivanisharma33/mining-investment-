...
const programsDropdown = [
  ...
  },
  {
    ...
    titleDefault: "THE Tier 1 Conference Partnerships",
    descKey: "nav-partnership-desc",
    descDefault: "Align your brand with Canada's only Tier 1 mining investment conference",
    href: "/partnership",
    isExternal: false,
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
                        ...
                        if (item.isExternal) {
                          return (
                            ...
                            >
                              ...
                              <div className="flex flex-col">
                                <span className="text-sm font-bold text-[#C6112F] dark:text-[#C6112F] transition-colors flex items-center gap-1.5">
                                  {t(item.titleKey, item.titleDefault)}
                                  <svg className="w-3.5 h-3.5 opacity-60 group-hover/item:opacity-100" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                                  </svg>
                                </span>
                                <span className="text-xs text-neutral-500 dark:text-zinc-300 leading-relaxed mt-0.5">
